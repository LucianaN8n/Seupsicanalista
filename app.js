(function(){
  ...
  function buildHTML(data){
    ...
    // Eixo psicanalítico (sem menção a “supervisão”)
    ...
    function actionPlan(tags){
      ...
      pl.push(['Continuado', [
        'Revisão periódica com ajuste de foco conforme resposta do paciente.'
      ]]);
      return pl;
    }
    ...
    html += `<small class="helper">Hipóteses são clínicas (não diagnósticas).</small>`;
    return html;
  }
  ...
  $('#btnPdf')?.addEventListener('click', async ()=>{
    ...
    pdf.save(`plano_${paciente}_v3c.pdf`);
  });
